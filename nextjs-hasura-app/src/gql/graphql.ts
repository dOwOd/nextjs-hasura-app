...
export type GetArticlesByStatusQuery = { __typename?: 'query_root', articles: Array<{ __typename?: 'articles', id: any, slug: string, title: string, updated_at: any, created_at: any }> };
...
export type CreateArticleMutation = { __typename?: 'mutation_root', insert_articles_one?: { __typename?: 'articles', id: any } | null };
...
export type DeleteArticleByIdMutation = { __typename?: 'mutation_root', delete_articles_by_pk?: { __typename?: 'articles', id: any, slug: string, title: string } | null };


export const GetArticleBySlugDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetArticleBySlug"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"slug"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"articles"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"slug"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_eq"},"value":{"kind":"Variable","name":{"kind":"Name","value":"slug"}}}]}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"slug"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"content"}},{"kind":"Field","name":{"kind":"Name","value":"updated_at"}},{"kind":"Field","name":{"kind":"Name","value":"created_at"}}]}}]}}]} as unknown as DocumentNode<GetArticleBySlugQuery, GetArticleBySlugQueryVariables>;
...
export const CreateArticleDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateArticle"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"slug"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"title"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"content"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"status"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"insert_articles_one"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"object"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"slug"},"value":{"kind":"Variable","name":{"kind":"Name","value":"slug"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"title"},"value":{"kind":"Variable","name":{"kind":"Name","value":"title"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"content"},"value":{"kind":"Variable","name":{"kind":"Name","value":"content"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"status"},"value":{"kind":"Variable","name":{"kind":"Name","value":"status"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<CreateArticleMutation, CreateArticleMutationVariables>;
...
export const GetArticlesByStatusDocument = gql`
...
/**
 * __useGetArticlesByStatusQuery__
 *
 * To run a query within a React component, call `useGetArticlesByStatusQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetArticlesByStatusQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetArticlesByStatusQuery({
 *   variables: {
 *      status: // value for 'status'
 *   },
 * });
 */
export function useGetArticlesByStatusQuery(baseOptions: Apollo.QueryHookOptions<GetArticlesByStatusQuery, GetArticlesByStatusQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetArticlesByStatusQuery, GetArticlesByStatusQueryVariables>(GetArticlesByStatusDocument, options);
      }
export function useGetArticlesByStatusLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetArticlesByStatusQuery, GetArticlesByStatusQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetArticlesByStatusQuery, GetArticlesByStatusQueryVariables>(GetArticlesByStatusDocument, options);
        }
export type GetArticlesByStatusQueryHookResult = ReturnType<typeof useGetArticlesByStatusQuery>;
export type GetArticlesByStatusLazyQueryHookResult = ReturnType<typeof useGetArticlesByStatusLazyQuery>;
export type GetArticlesByStatusQueryResult = Apollo.QueryResult<GetArticlesByStatusQuery, GetArticlesByStatusQueryVariables>;
...
export const CreateArticleDocument = gql`
    mutation CreateArticle($slug: String!, $title: String!, $content: String, $status: String!) {
  insert_articles_one(
...
export const DeleteArticleByIdDocument = gql`
  ...
  delete_articles_by_pk(id: $id) {
    ...
    `;
export type DeleteArticleByIdMutationFn = Apollo.MutationFunction<DeleteArticleByIdMutation, DeleteArticleByIdMutationVariables>;

/**
 * __useDeleteArticleByIdMutation__
 *
 * To run a mutation, you first call `useDeleteArticleByIdMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useDeleteArticleByIdMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [deleteArticleByIdMutation, { data, loading, error }] = useDeleteArticleByIdMutation({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useDeleteArticleByIdMutation(baseOptions?: Apollo.MutationHookOptions<DeleteArticleByIdMutation, DeleteArticleByIdMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<DeleteArticleByIdMutation, DeleteArticleByIdMutationVariables>(DeleteArticleByIdDocument, options);
      }
export type DeleteArticleByIdMutationHookResult = ReturnType<typeof useDeleteArticleByIdMutation>;
export type DeleteArticleByIdMutationResult = Apollo.MutationResult<DeleteArticleByIdMutation>;
export type DeleteArticleByIdMutationOptions = Apollo.BaseMutationOptions<DeleteArticleByIdMutation, DeleteArticleByIdMutationVariables>;