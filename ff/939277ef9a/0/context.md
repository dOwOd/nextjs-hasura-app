...
さっき作ってもらった執筆を行うAgent Teamはファイルに残していなかったのですか？

### Prompt 86

図を作るエージェントではありません。記事を執筆するAgent Teamです。先程私の記事の文体などを学んでもらい作成されたAgent Teamがあるはずです

### Prompt 87

作成してください。チームの中にはhttps://www.dowo.dev/ の記事の文体や文章の特徴、クセなどを分析できる役割をもったメンバーも用意して
