...
「`rewrites` / `redirects` が使えない」コレは正しいですか？

### Prompt 52

「わかっていたけど、実際に削除していくと結構な量になった。」ここはどういうニュアンスの文章？

### Prompt 53

結構な量になったのは使えない機能ですか？修正箇所ですか？

### Prompt 54

そもそもこのセクションでは何を伝えたいのですか？特にハマっては無いと思うのでハマりどころというセクション内で何を伝えたいのかがわかりません
...
「### repository_dispatch から Deploy Hooks へ」についてはPhase7と何が違いますか？
...
before afterで （`output: 'export'`） と書く必要ある？

### Prompt 59

コミットして引き続きドキュメントを作って
...
コンテキストがいっぱいになってきたのでコミットして引き続きドキュメントを作って
